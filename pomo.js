(function(ctx) {
  ...
  entryExists = function(hash, domain, escaped) {
    return (
      !!hash &&
      !!hash.contents &&
      !!hash.contents[domain] &&
      !!hash.contents[domain][escaped]
    );
  };
  var Errors = {};
  ...
  Parser.Object = function(msg) {
    ...
    this.toString = function() {
      ...
      canGetPluralIndex =
        !this.isPlural &&
        this.plural_forms &&
        this.plural_forms.push &&
        !!Parser.Object.calculatePluralIndex;
  ...
  Parser.POFiles = {
    parse: function(text, translation_domain) {
      ...
      var parsed = {},
        ...
        part,
        domain =
          typeof translation_domain === "undefined"
            ? "messages"
            : translation_domain,
        counter = 0,
        text = text.replace(/\r\n|\r/g, "\n"),
  ...
  var Pomo = function() {
    ...
    me.getText = function(msg_id, options) {
      ...
      if (entryExists(me.storage, domain, escaped)) {
        ...
        if (!!variables) {
          var bare_string = is_bare_string
              ? translation
