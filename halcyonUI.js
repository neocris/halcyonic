$(window).resize(function() {
  if ($(window).width() < 1200 && responsive_design == false) {
    ...
    $(".left_column").append(
      $("<div>")
        .attr("class", "responsive_left")
        .append($(".right_column").children())
    );
    $(".right_column").remove();
    ...
    $(".article_wrap").append(
      $("<div>")
        .attr("class", "right_column")
        .append($(".responsive_left").children())
    );
...
$(function() {
  ...
  $(document).on("click", ".follow_button", function(e) {
    ...
    if ($(this).attr("mid") !== null) {
      api.post("accounts/" + $(this).attr("mid") + "/follow", function(
        data
      ) {});
  ...
  $(document).on("click", ".following_button", function(e) {
    e.stopPropagation();
    if ($(this).attr("mid") !== null) {
      api.post("accounts/" + $(this).attr("mid") + "/unfollow", function(
        data
      ) {});
    }
    $(this).toggleClass("following_button");
    $(this).toggleClass("follow_button");
    $(this).html(
      '<i class="fa fa-fw fa-user-plus"></i><span>' + __("Follow") + "</span>"
    );
    return false;
  });
  $(document).on("click", ".mute_button", function(e) {
    ...
    $(".overlay_confirm_text").text(
      __("Are you sure that you want to mute this user?")
    );
  ...
  $(document).on("click", ".muting_button", function(e) {
    if ($(this).attr("mid") != null) {
      api.post("accounts/" + $(this).attr("mid") + "/unmute", function(
        data
      ) {});
    }
  ...
  $(document).on("click", ".block_button", function(e) {
    ...
    $(".overlay_confirm").removeClass("invisible");
    $(".overlay_confirm_text").text(
      __("Are you sure that you want to block this user?")
    );
    $(".overlay_confirm_yes").click(function() {
      $(".close_button").click();
  ...
  $(document).on("click", ".blocking_button", function(e) {
    e.stopPropagation();
    if ($(this).attr("mid") !== null) {
      api.post("accounts/" + $(this).attr("mid") + "/unblock", function(
        data
      ) {});
    }
  ...
  $(document).on("click", ".boost_button", function(e) {
    ...
    if ($(this).attr("reblogged") !== "true") {
      api.post("statuses/" + $(this).attr("tid") + "/reblog", function(
        data
      ) {});
      ...
      api.post("statuses/" + $(this).attr("tid") + "/unreblog", function(
        data
      ) {});
  ...
  $(document).on("click", ".fav_button", function(e) {
    ...
    if ($(this).attr("favourited") !== "true") {
      api.post("statuses/" + $(this).attr("tid") + "/favourite", function(
        data
      ) {});
      $(this).attr("favourited", "true");
      $(this).toggleClass("active");
    } else {
      api.post("statuses/" + $(this).attr("tid") + "/unfavourite", function(
        data
      ) {});
  ...
  $(document).on("click", ".delete_button", function(e) {
    ...
    $(".overlay_confirm").removeClass("invisible");
    $(".overlay_confirm_text").text(
      __("Are you sure that you want to delete this toot?")
    );
    $(".overlay_confirm_yes").click(function() {
      $(".close_button").click();
      api.delete("statuses/" + sid, function(data) {
        if (
          ...
          $(".js_current_toots_count").html(
            --localStorage.current_statuses_count
          );
  ...
  $(document).on("click", ".pin_button", function(e) {
    ...
    api.post("statuses/" + sid + "/pin", function(data) {
      $('.toot_entry[sid="' + sid + '"] .pin_button')
        .removeClass("pin_button")
        .addClass("unpin_button")
        .text(__("Unpin Toot"));
  ...
  $(document).on("click", ".unpin_button", function(e) {
    ...
    api.post("statuses/" + sid + "/unpin", function(data) {
      $('.toot_entry[sid="' + sid + '"] .unpin_button')
        .removeClass("unpin_button")
        .addClass("pin_button")
        .text(__("Pin Toot"));
  ...
  $(document).on("click", ".addlist_button", function(e) {
    ...
    $(".overlay_addlist .overlay_simple_header span").html(
      __("Add to list") + ": " + $(this).attr("display_name")
    );
    replace_emoji();
                ...
                $("<div>")
                  ...
                  .append(
                    $("<button>")
                      ...
                      .append($("<span>").text(__("Add")))
                      .click(function(e) {
                        api.post(
                          "lists/" + list_id + "/accounts?account_ids[]=" + mid,
                          "",
                          function() {
                          ...
                          function(xhr) {
                            if (xhr.status == 422) {
                              $(
                                "#js-overlay_content_wrap .temporary_object"
                              ).empty();
                              $("#js-overlay_content_wrap").addClass("view");
                              $("#js-overlay_content_wrap").addClass(
                                "black_08"
                              );
                              $(".overlay_confirm").removeClass("invisible");
                              $(".overlay_confirm_text").text(
                                __(
                                  "You need to follow this user to add him/her to the list. Do you want to do that now?"
                                )
                              );
                              $(".overlay_confirm_yes").click(function() {
                                $(".close_button").click();
                                api.post(
                                  ...
                                  function(data) {
                                    putMessage(
                                      __("You successfully followed this user.")
                                    );
                                    api.post(
                                      "lists/" +
                                        list_id +
                                      ...
                                      function() {
                                        putMessage(
                                          __("Added this account to the list")
                                        );
                                      }
                                    );
                                  }
                ...
                $("<div>")
                  ...
                  .append(
                    $("<button>")
                      ...
                      .append($("<span>").text(__("Remove")))
                      .click(function(e) {
                        api.delete(
                          "lists/" + list_id + "/accounts?account_ids[]=" + mid,
                          function() {
                            putMessage(
                              __("Removed this account from the list")
                            );
                          }
                        );
                        $(".close_button").click();
  ...
  $(document).on("click", ".status_form.ready .active_submit_button", function(
    e
  ) {
...
function setTimeline(level, load_options, show_replies) {
  ...
  store_api.get().forEach(function(st){
    timeline_template(st).appendTo('#js-timeline');
  });
  api.get(level, load_options, function(statuses) {
    ...
    for (let i in statuses) {
      ...
      for (var a = 0; a < current_filters.length; a++) {
        if (
          ((level == "timelines/home" ||
            level.indexOf("timelines/list/") != -1) &&
            current_filters[a].context.indexOf("home") != -1 &&
            current_filters[a].irreversible == false) ||
          (!(
            level == "timelines/home" || level.indexOf("timelines/list/") != -1
          ) &&
            current_filters[a].context.indexOf("public") != -1)
        ) {
          if (current_filters[a].whole_word == false) {
            if (
              statuses[i].content.match(new RegExp(current_filters[a].phrase))
            )
              filterstatus = true;
          } else {
            if (
              statuses[i].content.match(
                new RegExp(
                  "[^a-zA-Z1-9]" + current_filters[a].phrase + "[^a-zA-Z1-9]"
                )
              )
            )
              filterstatus = true;
      ...
      if (
        filterstatus == false &&
        !(show_replies == "false" && statuses[i].in_reply_to_id) &&
        !(
          localStorage.setting_show_bots == "false" &&
          statuses[i].account.bot == true &&
          !level.match(/accounts\/\d+\/statuses/)
        ) &&
        !(statuses[i].visibility == "direct" && level == "timelines/home")
      ) {
        timeline_template(statuses[i]).appendTo("#js-timeline");
        if (
          statuses[i].in_reply_to_id &&
          (level === "timelines/home") | (level === "timelines/public")
        ) {
          if (localStorage.setting_thread_view == "true") {
            (function(this_id) {
              api.get("statuses/" + statuses[i].id + "/context", function(
                context
              ) {
                console.log(this_id);
                for (var b = 0; b < context.ancestors.length; b++) {
                  ...
                  for (var a = 0; a < current_filters.length; a++) {
                    if (current_filters[a].context.indexOf("thread") != -1) {
                      if (current_filters[a].whole_word == false) {
                        if (
                          context.ancestors[b].content.match(
                            new RegExp(current_filters[a].phrase)
                          )
                        )
                  ...
                  if (filterreplystatus == false) {
                    $(
                      "#js-timeline .toot_entry[sid='" +
                        context.ancestors[b].id +
                        "']"
                    ).remove();
                    $("#js-timeline .toot_entry[sid='" + this_id + "']").before(
                      context_template(
                        context.ancestors[b],
                        "ancestors_status default_padding"
                      )
                    );
  ...
  $(window).scroll(function() {
    if (
      ...
      if (!isSyncing) {
        isSyncing = true;
        load_options.unshift({
          name: "max_id",
          data: links["next"].match(/max_id=(.+)&?/)[1]
        });
        api.get(level, load_options, function(statuses) {
          if (statuses.length) {
            for (let i in statuses) {
              ...
              if (
                filterstatus == false &&
                timeline_hide_status.indexOf(statuses[i].id) == -1 &&
                !(show_replies == "false" && statuses[i].in_reply_to_id) &&
                !(
                  localStorage.setting_show_bots == "false" &&
                  statuses[i].account.bot == true &&
                ...
                if (
                  ...
                  if (localStorage.setting_thread_view == "true") {
                    (function(this_id) {
                      api.get(
                        "statuses/" + statuses[i].id + "/context",
                        function(context) {
                          console.log(this_id);
                          for (var b = 0; b < context.ancestors.length; b++) {
                            var filterreplystatus = false;
                            for (var a = 0; a < current_filters.length; a++) {
                              if (
                                current_filters[a].context.indexOf("thread") !=
                                -1
                              ) {
                                if (current_filters[a].whole_word == false) {
                                  if (
            ...
            $(".timeline_footer").append(
              '<img style="width: 30%;opacity: .3;" src="/assets/images/halcyon.png">'
            );
            isSyncing = true;
          }
        });
          ...
          if (streaming_option === "manual") {
            if (!$('.toot_entry[sid="' + userstream.payload.id + '"]').length) {
              ...
              for (var a = 0; a < current_filters.length; a++) {
                if (
                  ...
                  if (current_filters[a].whole_word == false) {
                    if (
                      userstream.payload.content.match(
                        new RegExp(current_filters[a].phrase)
                      )
                    )
                      filterstatus = true;
              ...
              if (
                filterstatus == false &&
                !(
                  show_replies == "false" && userstream.payload.in_reply_to_id
                ) &&
                !(
                  localStorage.setting_show_bots == "false" &&
                  userstream.payload.account.bot == true &&
                  !level.match(/accounts\/\d+\/statuses/)
                ) &&
                !(
                  userstream.payload.visibility == "direct" &&
                  level == "timelines/home"
                )
              ) {
                $("#js-stream_update").css({
                  display: "block",
                  height: "auto",
                  padding: "10px"
                });
                ...
                $("#header .header_nav_list ." + scope + "_badge").removeClass(
                  "invisible"
                );
              }
            }
            ...
            if (!$('.toot_entry[sid="' + userstream.payload.id + '"]').length) {
              ...
              if (
                ...
                if (
                  (level === "timelines/home") |
                  (level === "timelines/public")
                ) {
                  if (
                    userstream.payload.in_reply_to_id &
                    !$(".toot_entry[sid='" + userstream.in_reply_to_id + "']")
                      .length
                  ) {
                    let reply_source = userstream.payload.id;
                    api.get(
                      "statuses/" + userstream.payload.in_reply_to_id,
                      function(in_reply_statuses) {
                        var filterreplystatus = false;
                        for (var a = 0; a < current_filters.length; a++) {
                          if (
                            current_filters[a].context.indexOf("thread") != -1
                          ) {
                            if (current_filters[a].whole_word == false) {
                              if (
                                in_reply_statuses.content.match(
                                  new RegExp(current_filters[a].phrase)
                                )
                              )
                                filterreplystatus = true;
            ...
            if (scrollTop == 0) {
              if (
                !$('.toot_entry[sid="' + userstream.payload.id + '"]').length
              ) {
                var filterstatus = false;
                for (var a = 0; a < current_filters.length; a++) {
                  if (
                ...
                if (
                  ...
                  timeline_template(userstream.payload).prependTo(
                    "#js-timeline"
                  );
                  replaceInternalLink();
                  replace_emoji();
              ...
              if (
                ...
                if (
                  ...
                  !(
                    userstream.payload.visibility == "direct" && scope == "home"
                  )
                ) {
                  statuses.unshift(userstream.payload);
                  $("title").text(
                    "(" + statuses.length + ") " + original_title
                  );
                }
              }
            }
          ...
          for (let i in statuses) {
            ...
            if ((level === "timelines/home") | (level === "timelines/public")) {
              if (statuses[i].in_reply_to_id) {
                ...
                api.get("statuses/" + statuses[i].in_reply_to_id, function(
                  in_reply_statuses
                ) {
                  $(
                    "#js-timeline .toot_entry[sid='" + reply_source + "']"
                  ).before(
                    context_template(
                      in_reply_statuses,
                      "ancestors_status default_padding"
      ...
      if (
        ...
        if (statuses[i].in_reply_to_id) {
          if (!reply_sources[statuses[i].in_reply_to_id]) {
            ...
            api.getOther(
              instance + "statuses/" + statuses[i].in_reply_to_id,
              function(in_reply_statuses) {
                var filterreplystatus = false;
                for (var a = 0; a < current_filters.length; a++) {
                  if (current_filters[a].context.indexOf("thread") != -1) {
                ...
                if (filterreplystatus == false) {
                  $(
                    "#js-timeline .toot_entry[sid='" +
                      reply_sources[in_reply_statuses.id] +
                      "']"
                  ).before(
                    context_template(
                      in_reply_statuses,
  ...
  api.get("notifications", load_options, function(NotificationObj) {
    for (let i in NotificationObj) {
      ...
      if (NotificationObj[i].type == "mention") {
        for (var a = 0; a < current_filters.length; a++) {
          if (
            current_filters[a].context.indexOf("notifications") != -1 &&
            current_filters[a].irreversible == false
          ) {
            if (current_filters[a].whole_word == false) {
              if (
                NotificationObj[i].status.content.match(
                  new RegExp(current_filters[a].phrase)
                )
              )
                filterstatus = true;
        ...
        api.get("notifications", load_options, function(NotificationObj) {
          if (NotificationObj.length) {
            for (let i in NotificationObj) {
              ...
              if (filterstatus == false)
                notifications_template(NotificationObj[i]).appendTo(
                  "#js-timeline"
                );
            }
            links = getLinkFromXHRHeader(responce_headers);
        ...
        if (userstream.payload.type == "mention") {
          for (var a = 0; a < current_filters.length; a++) {
            if (
              ...
              if (current_filters[a].whole_word == false) {
                if (
                  userstream.payload.status.content.match(
                    new RegExp(current_filters[a].phrase)
                  )
                )
                  filterstatus = true;
  ...
  $(window).scroll(function() {
    if (
      ...
      if (!isSyncing) {
        ...
        api.get("accounts/" + mid + "/" + param, load_options, function(
          follows
        ) {
          let followsList = [];
          if (follows.length) {
...
function setUserSearch(query) {
  api.get(
    "search",
    [{ name: "q", data: query }, { name: "resolve", data: "true" }],
    function(search) {
...
function setAccount(AccountObj) {
  ...
  for (i = 0; i < AccountObj.emojis.length; i++) {
    AccountObj.display_name = AccountObj.display_name.replace(
      new RegExp(":" + AccountObj.emojis[i].shortcode + ":", "g"),
      "<img src='" + AccountObj.emojis[i].url + "' class='emoji'>"
    );
  }
  const calendar = [
    __("Jan"),
  ...
  creation_date =
    calendar[creation_date.getUTCMonth()] +
    " " +
    creation_date.getUTCFullYear();
  var account_state_icons = "";
  if (AccountObj.locked == true)
    account_state_icons += " <i class='fa fa-lock'></i>";
  if (AccountObj.bot == true)
    account_state_icons +=
      " <img src='/assets/images/robot.svg' class='emoji'>";
  ...
  $("#js_profile_displayname")
    .addClass("emoji_poss")
    .html(AccountObj.display_name);
  $("#js_profile_username").html(AccountObj.acct + account_state_icons);
  $("#js_profile_bio")
    .addClass("emoji_poss")
    .html(AccountObj.note);
  $("#js_profile_bio .emojione")
    .removeClass("emojione")
    .addClass("emoji");
  $("#js_profile_public_link a").attr("href", AccountObj.url);
  $("#js_profile_joined_date span span").text(
    __("Joined at") + " " + creation_date
  );
  for (var i = 0; i < AccountObj.fields.length; i++) {
    if (AccountObj.fields[i].verified_at != null)
      var verified = $("<i>")
        .addClass("fa fa-check-circle")
        .addClass("profile_field_verified");
    else var verified = "";
    $("#js_profile_fields").append(
      $("<div>")
        .addClass("profile_field")
        .append(
          $("<span>")
            .addClass("profile_field_header")
            .addClass("emoji_poss")
            .text(AccountObj.fields[i].name)
            .prepend(verified)
        )
        .append($("<br>"))
        .append(
          $("<span>")
            .addClass("profile_field_value")
            .addClass("emoji_poss")
            .html(AccountObj.fields[i].value)
        )
    );
  }
...
<span>${__("Show")}</span>
    ...
    api.get(
      "accounts/relationships",
      [{ name: "id", data: String(AccountObj.id) }],
      function(RelationshipObj) {
        if (RelationshipObj[0].followed_by) {
          $("#main .profile_username .profile_followed_by").removeClass(
            "invisible"
          );
        }
        if (RelationshipObj[0].blocking) {
          $(`<button class="blocking_button relationship_button" mid="${
            AccountObj.id
          }">
<span>${__("Blocking")}</span>
</button>`).appendTo(".profile_button_box");
        } else if (RelationshipObj[0].muting) {
          $(`<button class="muting_button relationship_button" mid="${
            AccountObj.id
          }">
<span>${__("Muting")}</span>
</button>`).appendTo(".profile_button_box");
...
<span>${__("Requested")}</span>
          ...
          $(`<button class="following_button relationship_button" mid="${
            AccountObj.id
          }">
<span>${__("Following")}</span>
</button>`).appendTo(".profile_button_box");
        } else {
          $(`<button class="follow_button relationship_button" mid="${
            AccountObj.id
          }">
...
function setRecentImages(mid) {
  api.get(
    "accounts/" + mid + "/statuses",
    [{ name: "only_media", data: "true" }, { name: "limit", data: "6" }],
    function(statuses) {
      if (statuses.length) {
        $("#js_profile_recent_images span").text(
          `${statuses[0].account.statuses_count} ${__("Photos and toots")}`
        );
        $("#js_profile_recent_images a").attr(
          "href",
          $("#media_link").attr("href")
        );
        for (i in statuses) {
          $(`<div class="profile_recent_images_item media_attachment" otype="image" sid="${
            statuses[i].id
          }" url="${statuses[i].media_attachments[0].preview_url}">
...
function setInstance() {
  api.get("instance", function(data) {
    ...
    api.get(
      "accounts/relationships",
      [{ name: "id", data: data.contact_account.id }],
      function(RelationshipsObj) {
        if (RelationshipsObj[0].following) {
          const button = $(
            '#js-follows_profile .follow_button[mid="' +
              RelationshipsObj[0].id +
              '"]'
          );
          button.removeClass("follow_button");
          button.addClass("following_button");
...
function badges_update() {
  ...
  api.stream("user", function(userstream) {
    if ((userstream.event === "update") & (location.pathname !== "/")) {
      ...
      $("#header .header_nav_list .notification_badge").text(current_count);
      if (
        $("#header .header_nav_list .notification_badge").hasClass("invisible")
      ) {
        $("#header .header_nav_list .notification_badge").removeClass(
          "invisible"
        );
      }
    }
    if (userstream.event === "notification") {
      if (userstream.payload.account.display_name.length == 0) {
        userstream.payload.account.display_name =
          userstream.payload.account.username;
      }
      switch (userstream.payload.type) {
        ...
        case "reblog":
          pushNotification(
            ...
            userstream.payload.account.display_name +
              " " +
              __("boosted your toot")
          );
          break;
        case "follow":
          pushNotification(
            __("New follower"),
            userstream.payload.account.display_name + " " + __("followed you")
          );
          $(".js_current_followers_count").html(
            ++localStorage.current_followers_count
          );
          break;
        case "mention":
          pushNotification(
            __("New mention"),
            userstream.payload.account.display_name + " " + __("mentioned you")
          );
          break;
        case "poll":
          pushNotification(
  ...
  if (localStorage.setting_service_worker == "true") {
    if ("serviceWorker" in navigator) {
      navigator.serviceWorker
        .register("/assets/js/halcyon/halcyonWorker.js")
        ...
        .catch(function(error) {
          console.log(
            "There was an error when registering the service worker",
            error
          );
        });
    }
...
function setOverlayStatus(sid) {
  if (!window.getSelection().toString()) {
    ...
    api.get("statuses/" + sid + "/", function(status) {
      $('<div class="toot_detail_wrap"></div>').appendTo(
        "#js-overlay_content .temporary_object"
      );
      status_template(status, "main_status").appendTo(
        "#js-overlay_content .toot_detail_wrap"
      );
      replaceInternalLink();
      replace_emoji();
          ...
          for (let i in status.ancestors) {
            ...
            for (var a = 0; a < current_filters.length; a++) {
              if (current_filters[a].context.indexOf("thread") != -1) {
                if (current_filters[a].whole_word == false) {
                  if (
                    status.ancestors[i].content.match(
                      new RegExp(current_filters[a].phrase)
                    )
                  )
                    filterreplystatus = true;
            ...
            if (filterreplystatus == false)
              context_template(
                ...
                "#js-overlay_content .temporary_object .toot_detail_wrap"
              );
          }
        }
          ...
          for (let i in status.descendants) {
            ...
            for (var a = 0; a < current_filters.length; a++) {
              if (current_filters[a].context.indexOf("thread") != -1) {
                if (current_filters[a].whole_word == false) {
                  if (
                    status.descendants[i].content.match(
                      new RegExp(current_filters[a].phrase)
                    )
                  )
                    filterreplystatus = true;
            ...
            if (filterreplystatus == false) {
              if (
                i < status.descendants.length - 1 &&
                status.descendants[i].id ==
                  status.descendants[parseInt(i) + 1].in_reply_to_id
              ) {
                context_template(
                  status.descendants[i],
                  "descendants_status direct_answer"
                ).appendTo(
                  "#js-overlay_content .temporary_object .toot_detail_wrap"
                );
              } else
...
$(function() {
  $(document).on(
    "click",
    ".toot_entry.ancestors_status, .toot_entry.descendants_status",
    function(e) {
      $("#js-overlay_content .temporary_object").empty();
    }
  );
...
function setOverlayMedia(sid, mediacount) {
  ...
  api.get("statuses/" + sid, function(status) {
    if (!status.reblog) {
      media_template(status, mediacount).appendTo(
        "#js-overlay_content .temporary_object"
      );
      replaceInternalLink();
      replace_emoji();
    } else {
      media_template(status.reblog, mediacount).appendTo(
        "#js-overlay_content .temporary_object"
      );
      replaceInternalLink();
      replace_emoji();
...
$(document).on("emojiready", function() {console.log('emoji');
...
function handleMediaUpload(place, f) {
  if (
    $("#" + place + "_status_form .media_attachments_preview_area").children()
      .length == 4
  ) {
    putMessage(__("You can only add four pictures to one post!"));
  } else if (
    $("#" + place + "_status_form .status_media_attachment").hasClass(
      "disabled"
    )
  ) {
    ...
    if (
      ...
      $(
        "#" +
          place +
          "_status_form .status_textarea .media_attachments_preview_area"
    ...
    reader.onloadend = (function() {
      return function(e) {
        ...
        if (f.type.indexOf("image") != -1)
          var mediaelement = `<img src="${
            e.target.result
          }" class="media_element" data-random="${imgrandom}">`;
        if (f.type.indexOf("video") != -1)
          var mediaelement = `<video src="${
            e.target.result
          }" muted class="media_element" data-random="${imgrandom}">`;
        if (f.type.indexOf("audio") != -1)
          var mediaelement = `<span class="media_element" data-random="${imgrandom}"><center><i class="fa fa-file-audio-o" style="font-size:7em"></i></center></span>`;
...
${mediaelement}
        ...
        $(html).appendTo(
          "#" + place + "_status_form .media_attachments_preview_area"
        );
      };
    })(f);
  }
...
function initStatusEditor(place) {
  ...
  $("label[for=" + place + "_status_emoji]").click(function(e) {
    $("#" + place + "_status_emoji").trigger("click", e);
  });
  $(document).on(
    "change keyup",
    "#" +
      place +
      "_status_form textarea,#" +
      place +
      "_status_form .status_spoiler,#" +
      place +
      "_status_form .poll_days,#" +
      place +
      "_status_form .poll_hours,#" +
      place +
      "_status_form .poll_mins",
    function(e) {
      var is_ready;
      if ((e.keyCode !== 224) & (e.keyCode !== 17)) {
        ...
        if ($("#" + place + "_status_form textarea").length == 1) {
          const textCount =
            $("#" + place + "_status_form textarea").val().length +
            $("#" + place + "_status_form .status_spoiler").val().length;
      ...
      if (
        $("#" + place + "_status_form .status_poll_editor").hasClass(
          "invisible"
        )
      ) {
        ...
        if (
          $("#" + place + "_status_form .poll_days").is(":valid") &&
          $("#" + place + "_status_form .poll_hours").is(":valid") &&
          $("#" + place + "_status_form .poll_mins").is(":valid")
        ) {
          if (is_ready) $("#" + place + "_status_form").addClass("ready");
          else $("#" + place + "_status_form").removeClass("ready");
  ...
  $(document).on("click", "#" + place + "_status_form .status_CW", function(e) {
    ...
    $("#" + place + "_status_form .status_textarea").toggleClass(
      "status_has_cw"
    );
  });
  $(document).on("click", "#" + place + "_status_form .status_poll", function(
    e
  ) {
    $("#" + place + "_status_form .status_poll_editor").toggleClass(
      "invisible"
    );
    $("#" + place + "_status_form .status_media_attachment").toggleClass(
      "disabled"
    );
  ...
  $(document).on(
    "click",
    "#" + place + "_status_form .expand_privacy_menu_button",
    function(e) {
      $("#" + place + "_status_form .expand_privacy_menu").removeClass(
        "invisible"
      );
    }
  );
  $(document).on(
    "click",
    "#" + place + "_status_form .status_addfield",
    function(e) {
      var new_textarea = $("<textarea>")
        .addClass("focus")
        .addClass("additional_textarea")
        .attr("name", "status_textarea")
        .data("random", Math.round(Math.random() * 1000));
      autosize(new_textarea);
      enableAutoComplete(new_textarea);
      $("#" + place + "_status_form textarea")
        .last()
        .after(new_textarea);
    }
  );
  $(document).on(
    "click",
    "#" + place + "_status_form .status_privacy.select_privacy",
    function(e) {
      e.stopPropagation();
      $("#" + place + "_status_form .expand_privacy_menu_button > i").attr(
        "class",
        $(this).attr("privacyicon")
      );
      $("#" + place + "_status_form .expand_privacy_menu").addClass(
        "invisible"
      );
    }
  );
  $(document).on("change", "#" + place + "_status_media_atta", function(e) {
    for (let i = 0, f; (f = e.target.files[i]); i++) {
      if (
        ...
        handleMediaUpload(place, f);
    }
  });
  $(document).on("click", "#" + place + "_status_form .status_NSFW", function(
    e
  ) {
    $("#" + place + "_status_form .media_attachments_preview_area").toggleClass(
      "nsfw"
    );
  });
  $(document).on(
    "click",
    "#" + place + "_status_form .media_attachments_delete_button",
    function(e) {
      e.stopPropagation();
      delete image_uploads[place][
        $(this)
          .parent()
          .children(".media_element")
          .data("random")
      ];
      $(this)
        .parent()
  ...
  $(document).on(
    "click",
    "#" + place + "_status_form .media_attachments_caption_button",
    function(e) {
      e.stopPropagation();
      $("#caption_status_form").data("place", place);
      $("#caption_status_form").data(
        "random",
        $(this)
          .parent()
          .children(".media_element")
      ...
      if (
        ...
        $("#caption_status_form .status_textarea textarea").val(
          image_uploads[place][
            $(this)
              .parent()
              .children(".media_element")
      ...
      $("#js-overlay_content_wrap").addClass("view");
      $("#js-overlay_content_wrap").addClass("black_08");
      $(".caption_status .submit_status_label").addClass(
      ...
      $(".caption_status .report_status_header span")
        .addClass("emoji_poss")
        .html(__("Add a caption to the media file"));
  ...
  $(document).on(
    "paste",
    "#" + place + "_status_form .status_textarea",
    function(e) {
      e = e.originalEvent;
  ...
  $(document).on(
    "dragstart",
    "#" + place + "_status_form .media_attachments_preview",
    function(e) {
  ...
  $(document).on(
    ...
    function(e) {
      ...
      $("#" + place + "_status_form .media_attachments_preview").removeClass(
        "over"
      );
      $("#" + place + "_status_form .media_attachments_preview").removeClass(
        "moving"
  ...
  $(document).on(
    "click",
    "#" + place + "_status_form .submit_status_label",
    function(e) {
      $("#" + place + "_status_form").addClass("ready");
      $("#" + place + "_status_form .status_textarea").addClass(
        "disallow_select"
      );
      $("#" + place + "_status_form .character_count").html(
      ...
      payload = {
          ...
          account: {
              ...
              emojis: [],
              acct: "botdroid",
              avatar: "a28af338ca81ea1c.png"
          },
          in_replay_to_id: "",
          in_replay_to_account_id: "",
          reblog: null,
          content: $('.status_textarea textarea').val(),
          created_at: "",
          emojis: [],
          replies_count: 0,
          reblogs_count: 0,
      ...
      //timeline_template(userstream.payload).prependTo("#js-timeline");
      timeline_template(payload).prependTo("#js-timeline");
      //push to git repo
      store_api.post(payload);

      if (
        !Object.keys(image_uploads[place]).length ||
        !$("#" + place + "_status_form .status_poll_editor").hasClass(
          "invisible"
        )
      ) {
        ...
        if (
          ...
          for (
            var i = 0;
            i < $("#" + place + "_status_form .poll_field").length;
            i++
          ) {
            if (
              $("#" + place + "_status_form .poll_field")
                .eq(i)
                .val().length > 0
            )
              params.poll.options.push(
                $("#" + place + "_status_form .poll_field")
                  .eq(i)
                  .val()
              );
          ...
          if (params.poll.options.length > 0) {
            params.poll.expires_in =
              $("#" + place + "_status_form .poll_days").val() * 86400 +
              $("#" + place + "_status_form .poll_hours").val() * 3600 +
              $("#" + place + "_status_form .poll_mins").val() * 60;
            if (
              $("#" + place + "_status_form .poll_multiple_choice")[0].checked
            )
              params.poll.multiple = "On";
          }
        }
        submitStatusArray(params, function(data) {
          ...
          $("#" + place + "_status_form .status_textarea").removeClass(
            "disallow_select"
          );
          $("#" + place + "_status_form .character_count").html(
            current_instance_charlimit
          );
          $("." + place + "_status .submit_status_label").removeClass(
            "active_submit_button"
          );
          $("." + place + "_status").addClass("invisible");
        ...
        for (var i in image_uploads[place]) {
          ...
          if (image_uploads[place][i].caption)
            formData.append("description", image_uploads[place][i].caption);
          if (count === 3 || count === filesLen) {
            api.postMedia("media", formData, function(postMedia) {
              ...
              if (place == "reply")
                ...
                params.in_reply_to_id = $("#single_reply_status_form").attr(
                  "tid"
                );
              submitStatusArray(params, function(data) {
                $(
                ...
                $("#" + place + "_status_form .status_spoiler").addClass(
                  "invisible"
                );
                $(
                  "#" +
                ...
                $("#" + place + "_status_form .status_poll").removeClass(
                  "disabled"
                );
                form.reset();
                delete image_uploads[place];
                ...
                $("." + place + "_status").addClass("invisible");
                autosize.destroy(
                  $("#" + place + "_status_form .status_textarea textarea")
                );
...
function openStatusEditor(place) {
  ...
  $("#" + place + "_status_emoji").lsxEmojiPicker({
    ...
    onSelect: function(emoji) {
      $(
        "#" +
          place +
          "_status_form .status_top .status_spoiler,#" +
          place +
          "_status_form .status_textarea textarea"
      ).each(function() {
  ...
  if (localStorage.setting_post_sensitive == "true") {
    ...
    $("#" + place + "_status_form .media_attachments_preview_area").addClass(
      "nsfw"
    );
  }
...
$(function() {
  $(document).on("click", function(e) {
    if (
      !$(e.target).closest("#creat_status").length &&
      !$(e.target).closest(".overlay_status").length
    ) {
      $("#overlay_status_emoji").lsxEmojiPicker("destroy");
      $("#overlay_status_form .status_top .status_spoiler").autoCompleteToken(
        "destroy"
      );
      $("#overlay_status_form .status_textarea textarea").autoCompleteToken(
        "destroy"
      );
    }
  });
  $(document).on("click", "#creat_status,.profile_sendto", function(e) {
    ...
    $(
      "#overlay_status_form .status_textarea .media_attachments_preview_area"
    ).addClass("invisible");
    ...
    $("#overlay_status_form .expand_privacy_menu_button > i").attr(
      "class",
      "fa fa-" + picon
    );
    if ($(this).attr("display_name"))
      $(".overlay_status .overlay_status_header span")
        .addClass("emoji_poss")
        .html(__("Toot to") + " " + $(this).attr("display_name"));
    else
      $(".overlay_status .overlay_status_header span").html(
        __("Compose new Toot")
      );
    if ($(this).attr("acct"))
      $("#overlay_status_form textarea").val($(this).attr("acct") + " ");
  ...
  $(document).on("click", function(e) {
    if (!$(e.target).closest("#reply_status_form").length) {
      ...
      $("#reply_status_form .status_top .status_spoiler").autoCompleteToken(
        "destroy"
      );
      $("#reply_status_form .status_textarea textarea").autoCompleteToken(
        "destroy"
      );
    }
  });
  ...
  $(document).on("click", function(e) {
    if (
      !$(e.target).closest(".reply_button").length &&
      !$(e.target).closest(".single_reply_status").length
    ) {
      $("#single_reply_status_emoji").lsxEmojiPicker("destroy");
      $("#single_status_form .status_top .status_spoiler").autoCompleteToken(
        "destroy"
      );
      $("#single_status_form .status_textarea textarea").autoCompleteToken(
        "destroy"
      );
    }
  });
  $(document).on(
    "click",
    "single_reply_status_header, #single_reply_status_form",
    function(e) {
      e.stopPropagation();
    }
  );
  $(document).on("click", ".reply_button", function(e) {
    ...
    $(
      "#single_reply_status_form .status_textarea .media_attachments_preview_area"
    ).addClass("invisible");
    ...
    $('#single_reply_status_form input[name="privacy_option"]').val([
      privacy_mode
    ]);
    $("#single_reply_status_form .expand_privacy_menu_button > i").attr(
      "class",
      "fa fa-" + picon
    );
    $("#single_reply_status_form").attr("tid", sid);
    $(".single_reply_status .single_reply_status_header span")
      .addClass("emoji_poss")
      .html(__("Reply to") + " " + display_name);
    $("#single_reply_status_form textarea").val(replyto);
    openStatusEditor("single_reply");
    api.get("statuses/" + sid + "/", function(status) {
      timeline_template(status).appendTo(
  ...
  $(document).on("click", function(e) {
    if (!$(e.target).closest("#header_status_form").length) {
      $("#header_status_form .submit_status_label").removeClass(
        "active_submit_button"
      );
      ...
      $("#header_status_form .status_top .status_spoiler").autoCompleteToken(
        "destroy"
      );
      $("#header_status_form .status_textarea textarea").autoCompleteToken(
        "destroy"
      );
  ...
  $(document).on("click", "#header_status_form", function(e) {
    switch ("public") { //localStorage.getItem("setting_post_privacy")
      case "public":
        picon = "globe";
        break;
      case "unlisted":
    ...
    if (!$("#header_status_form .status_textarea textarea").hasClass("focus")) {
      ...
      $('#header_status_form input[name="privacy_option"]').val([
        localStorage.getItem("setting_post_privacy")
      ]);
      $("#header_status_form .expand_privacy_menu_button > i").attr(
        "class",
        "fa fa-" + picon
      );
...
$(function() {
  $(document).on(
    "click",
    "caption_status_header, #caption_status_form",
    function(e) {
      e.stopPropagation();
    }
  );
  ...
  $(document).on("click", "#caption_status_form .submit_status_label", function(
    e
  ) {
    image_uploads[$("#caption_status_form").data("place")][
      $("#caption_status_form").data("random")
    ].caption = $("#caption_status_form .status_textarea textarea").val();
    document.forms.caption_status_form.reset();
    $("#caption_status_form .character_count").html("420");
    $(".caption_status .submit_status_label").removeClass(
      "active_submit_button"
    );
    ...
    if ($("#caption_status_form").data("place") == "header") {
      $("#js-overlay_content_wrap").removeClass("view");
      $("#js-overlay_content_wrap").removeClass("black_05");
    } else if ($("#caption_status_form").data("place") == "reply")
      $(".toot_detail_wrap").removeClass("invisible");
    else
      $("." + $("#caption_status_form").data("place") + "_status").removeClass(
        "invisible"
      );
...
$(function() {
  $(document).on("click", "report_status_header, #report_status_form", function(
    e
  ) {
    e.stopPropagation();
  });
  $(document).on("click", ".report_button", function(e) {
    ...
    $(".report_status .report_status_header span")
      .addClass("emoji_poss")
      .html(__("Report a Toot of") + " " + display_name);
  ...
  $(document).on("click", "#report_status_form .submit_status_label", function(
    e
  ) {
    $("#report_status_form").addClass("ready");
    $("#report_status_form .status_textarea").addClass("disallow_select");
    $("#report_status_form .character_count").html(
      '<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>'
    );
    ...
    api.post("reports", params, function(data) {
      ...
      $("#report_status_form .character_count").html("1000");
      $(".report_status .submit_status_label").removeClass(
        "active_submit_button"
      );
...
$(function() {
  $(document).on(
    "click",
    ".temporary_object > *, .parmanent_object > *",
    function(e) {
      e.stopPropagation();
    }
  );
  $(document).on("click", "#js-overlay_content_wrap", function(e) {
    if (
      (!$("#js-overlay_content_wrap .overlay_status").hasClass("invisible") &&
        ($("#js-overlay_content_wrap .overlay_status textarea").val().length >
          0 ||
          $("#overlay_status_form .media_attachments_preview_area").children()
            .length > 0)) ||
      (!$("#js-overlay_content_wrap .single_reply_status").hasClass(
        "invisible"
      ) &&
        ($("#js-overlay_content_wrap .single_reply_status textarea").val()
          .length > 0 ||
          $(
            "#single_reply_status_form .media_attachments_preview_area"
          ).children().length > 0)) ||
      (!$("#js-overlay_content_wrap .report_status").hasClass("invisible") &&
        $("#js-overlay_content_wrap .report_status textarea").val().length >
          0) ||
      (!$("#js-overlay_content_wrap .caption_status").hasClass("invisible") &&
        $("#js-overlay_content_wrap .caption_status textarea").val().length >
          0) ||
      ($("#js-overlay_content_wrap #reply_status_form").length == 1 &&
        !$(".toot_detail_wrap").hasClass("invisible") &&
        ($("#js-overlay_content_wrap #reply_status_form textarea").val()
          .length > 0 ||
          $("#reply_status_form .media_attachments_preview_area").children()
            .length > 0))
    ) {
      $(document.body).append(
        $(`<div id="overlay_close_warning" style="position:fixed;z-index:1001;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,0.8)">
...
<div class="overlay_close_text" style="margin-bottom:10px">${__(
          "If you close the overlay, your text will get deleted! Are you sure you want to close it?"
        )}</div>
<div class="overlay_simple_controls">
<button class="overlay_confirm_yes toot_button" style="float:right"><div class="toot_button_label"><i class="fa fa-fw fa-check"></i><span>${__(
          "Yes"
        )}</span></div></button>
<a href="javascript:$('#overlay_close_warning').remove();void(0)" class="overlay_confirm_cancel halcyon_link" style="float:right;margin-top:5px;margin-right:10px"><i class="fa fa-times"></i> ${__(
          "Cancel"
        )}</a>
</div>
</div>
      ...
      $(".overlay_close .overlay_confirm_yes").click(function() {
        ...
        if (
          !$("#js-overlay_content_wrap .caption_status").hasClass(
            "invisible"
          ) &&
          $("#caption_status_form").data("place") != "header"
        ) {
          $(".caption_status").addClass("invisible");
          $(".caption_status textarea").val("");
          if ($("#caption_status_form").data("place") == "reply")
            $(".toot_detail_wrap").removeClass("invisible");
          else
            $(
              "." + $("#caption_status_form").data("place") + "_status"
            ).removeClass("invisible");
        } else closeOverlay();
      });
    } else if (
  ...
  function closeOverlay() {
    ...
    $(
      "#js-overlay_content .temporary_object, #js-overlay_content .parmanent_object"
    ).removeClass("visible");
    $(
      "#js-overlay_content_wrap .overlay_status.submit_status_label"
    ).removeClass("active_submit_button");
    $(
      "#js-overlay_content_wrap .single_reply_status .submit_status_label"
    ).removeClass("active_submit_button");
    $(
      "#js-overlay_content_wrap #reply_status_form .submit_status_label"
    ).removeClass("active_submit_button");
    $(
      "#js-overlay_content_wrap #header_status_form .submit_status_label"
    ).removeClass("active_submit_button");
    $("#js-overlay_content_wrap").removeClass("black_05");
...
$(function() {
  ...
  $(document).click(function(e) {
    if (
      !$(e.target).closest(".header_search_suggestions").length &&
      !$(e.target).closest("#search_form").length
    )
      $(".header_search_suggestions").addClass("invisible");
  });
  $(".search_form").submit(function(e) {
    e.preventDefault();
    searchredirect($("#search_form").val());
  });
  if ($("#js-overlay_content_wrap").hasClass("view"))
    $(document.body).css("overflow-y", "hidden");
  $("#js-overlay_content_wrap").attrchange(function(attr) {
    if (attr == "class" && $("#js-overlay_content_wrap").hasClass("view"))
      $(document.body).css("overflow-y", "hidden");
  ...
  $(document).on("click", ".media_detail .media_backward", function() {
    ...
    if ($(".media_detail").attr("cid") == 0)
      $(".media_detail .media_backward").fadeOut();
    $(".media_detail .media_forward").fadeIn();
    $(".media_detail .media_box img").attr(
      "src",
      JSON.parse($(".media_detail").attr("pictures"))[
        $(".media_detail").attr("cid")
      ]
    );
  });
  $(document).on("click", ".media_detail .media_forward", function() {
    $(".media_detail").attr(
      "cid",
      parseInt($(".media_detail").attr("cid")) + 1
    );
    if (
      $(".media_detail").attr("cid") ==
      JSON.parse($(".media_detail").attr("pictures")).length - 1
    )
      $(".media_detail .media_forward").fadeOut();
  ...
  $(document).on(
    "click",
    ".poll_vote_option,.poll_vote_label,.poll_vote",
    function(e) {
      e.stopPropagation();
    }
  );
  ...
  $(document).on(
    "focus",
    ".status_textarea textarea,.status_top .status_spoiler",
    function(e) {
